...
function createSettleAuthorization(args) {
    return new settleAuthorization_1.default(`${queueGroup_1.default.SETTLE_AUTHORIZATION}_${args.authorization._id}`, args.status, args.executed_at, args.count_try, args.authorization);
}
