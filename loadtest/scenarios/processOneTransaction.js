...
exports.default = (config) => __awaiter(this, void 0, void 0, function* () {
    ...
    const performances = yield request.get({
    ...
    const performance = yield request.get({
    ...
    const screen = yield request.get({
    ...
    // COA仮予約
    const reserveSeatsTemporarilyResult2 = yield sskts.COA.services.reserve.updTmpReserveSeat({
        theaterCode: theaterCode,
        dateJouei: dateJouei,
        titleCode: titleCode,
        titleBranchNum: titleBranchNum,
    ...
    const coaSeatAuthorization = {
        ...
        coa_tmp_reserve_num: reserveSeatsTemporarilyResult2.tmpReserveNum,
...
-------------------------------------------------------------------\n
\n
◆購入番号 ：${reserveSeatsTemporarilyResult2.tmpReserveNum}\n
◆電話番号 ：09012345678\n
◆合計金額 ：${totalPrice}円\n
\n
...
`;
    ...
    // 照会してみる
    const makeInrquiryResult = yield request.post({
